...
// При присвоении immutable объекта в переменную, происходит копирование «по значению», то есть полностью.
...
// В переменной, которой присвоен mutable объект, хранится не сам объект, а адрес его места в памяти, иными словами – «ссылка» на него.
